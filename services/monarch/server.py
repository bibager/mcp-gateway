...
# In-memory store for pending authorization codes (code -> metadata)
...
def _get_base_url(request: Request) -> str:
    ...
    if proto == "https" and base.startswith("http://"):
        ...
        # Fallback: always use https for DigitalOcean apps
...
app = Starlette(
    routes=[
        ...
        # OAuth 2.0 endpoints for Claude web connector
